...
unit CnScript_ToolsAPI_WelcomePage_D120A;
{ |<PRE>
================================================================================
* 软件名称：CnPack IDE 专家包
...
procedure SIRegister_INTAWelcomePageDataPluginListView(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'INTAWelcomePageCaptionFrame', 'INTAWelcomePageDataPluginListView') do
  with CL.AddInterface(CL.FindInterface('INTAWelcomePageCaptionFrame'),INTAWelcomePageDataPluginListView, 'INTAWelcomePageDataPluginListView') do
  begin
