...
begin
  ...
  begin
    RegisterMethod('Procedure AfterSave');
    RegisterMethod('Procedure BeforeSave');
    RegisterMethod('Procedure Destroyed');
...
procedure SIRegister_IOTACodeInsightViewer(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IUnknown', 'IOTACodeInsightViewer') do
  with CL.AddInterface(CL.FindInterface('IUnknown'),IOTACodeInsightViewer, 'IOTACodeInsightViewer') do
  begin
...
procedure SIRegister_IOTACodeInsightManager(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IUnknown', 'IOTACodeInsightManager') do
  with CL.AddInterface(CL.FindInterface('IUnknown'),IOTACodeInsightManager, 'IOTACodeInsightManager') do
  begin
...
procedure SIRegister_IOTAEditorServices(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAEditorServices60', 'IOTAEditorServices') do
  with CL.AddInterface(CL.FindInterface('IOTAEditorServices60'),IOTAEditorServices, 'IOTAEditorServices') do
  begin
...
procedure SIRegister_IOTABufferOptions(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTABufferOptions60', 'IOTABufferOptions') do
  with CL.AddInterface(CL.FindInterface('IOTABufferOptions60'),IOTABufferOptions, 'IOTABufferOptions') do
  begin
...
procedure SIRegister_IOTAServices(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAServices60', 'IOTAServices') do
  with CL.AddInterface(CL.FindInterface('IOTAServices60'),IOTAServices, 'IOTAServices') do
  begin
...
procedure SIRegister_IOTAMessageServices(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAMessageServices60', 'IOTAMessageServices') do
  with CL.AddInterface(CL.FindInterface('IOTAMessageServices60'),IOTAMessageServices, 'IOTAMessageServices') do
  begin
...
procedure SIRegister_IOTAMessageGroup(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IUnknown', 'IOTAMessageGroup') do
  with CL.AddInterface(CL.FindInterface('IUnknown'),IOTAMessageGroup, 'IOTAMessageGroup') do
  begin
...
procedure SIRegister_IOTADebuggerServices(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTADebuggerServices60', 'IOTADebuggerServices') do
  with CL.AddInterface(CL.FindInterface('IOTADebuggerServices60'),IOTADebuggerServices, 'IOTADebuggerServices') do
  begin
...
procedure SIRegister_IOTAProcess(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAProcess60', 'IOTAProcess') do
  with CL.AddInterface(CL.FindInterface('IOTAProcess60'),IOTAProcess, 'IOTAProcess') do
  begin
...
procedure SIRegister_IOTAThread(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAThread60', 'IOTAThread') do
  with CL.AddInterface(CL.FindInterface('IOTAThread60'),IOTAThread, 'IOTAThread') do
  begin
...
begin
  ...
  begin
    RegisterMethod('Function GetOTAThreadContext : Integer', cdRegister);
  end;
end;
...
procedure SIRegister_IOTAEditActions(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAEditActions60', 'IOTAEditActions') do
  with CL.AddInterface(CL.FindInterface('IOTAEditActions60'),IOTAEditActions, 'IOTAEditActions') do
  begin
...
begin
 ...
 CL.AddConstantN('cDefEdIDL','String').SetString( 'Borland.EditOptions.IDL');
  ...
  CL.AddTypeS('TOTAViewerSymbolFlags', '( vsfUnknown, vsfConstant, vsfType, vsf'
   ...
   +'nstructor, vsfDestructor, vsfInterface, vsfEvent )');
  CL.AddTypeS('TOTAViewerVisibilityFlags', '( vvfPrivate, vvfProtected, vvfPubl'
   +'ic, vvfPublished )');
...
begin
  ...
  begin
    RegisterMethod(@TNotifierObject.AfterSave, 'AfterSave');
    RegisterMethod(@TNotifierObject.BeforeSave, 'BeforeSave');
    RegisterMethod(@TNotifierObject.Destroyed, 'Destroyed');
    RegisterMethod(@TNotifierObject.Modified, 'Modified');
  end;
end;
