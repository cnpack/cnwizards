...
procedure SIRegister_INTAIDEInsightService180(CL: TPSPascalCompiler);
...
procedure SIRegister_INTACustomEditorSubView190(CL: TPSPascalCompiler);
...
procedure SIRegister_INTAToolbarStreamNotifier190(CL: TPSPascalCompiler);
procedure SIRegister_INTAToolbarStreamNotifier(CL: TPSPascalCompiler);
procedure SIRegister_INTACustomizeToolbarNotifier190(CL: TPSPascalCompiler);
...
procedure SIRegister_IOTASourceEditor180(CL: TPSPascalCompiler);
...
begin
  ...
  begin
    RegisterMethod('Function AddPluginInfo2( const ATitle, ADescription : string; const AImage : TGraphicArray; AIsUnRegistered : Boolean; const ALicenseStatus : string; const ASKUName : string) : Integer', cdRegister);
    RegisterMethod('Function AddProductInfo2( const ADialogTitle, ACopyright, ATitle, ADescription : string; AAboutImage : HBITMAP; const AProductImage : TGraphicArray; AIsUnRegistered : Boolean; const ALicenseStatus : string; const ASKUName : string; AAboutImageAlphaFormat : TOTAAlphaFormat) : Integer', cdRegister);
  end;
end;
...
begin
  ...
  begin
    RegisterMethod('Function AddPluginInfo1( const ATitle, ADescription : string; AImage : HBITMAP; AIsUnRegistered : Boolean; const ALicenseStatus : string; const ASKUName : string; AAlphaFormat : TOTAAlphaFormat) : Integer', cdRegister);
    RegisterMethod('Function AddProductInfo1( const ADialogTitle, ACopyright, ATitle, ADescription : string; AAboutImage, AProductImage : HBITMAP; AIsUnRegistered : Boolean; const ALicenseStatus : string; const ASKUName : string; AAboutImageAlphaFormat : TOTAAlphaFormat; AProductImageAlphaFormat : TOTAAlphaFormat) : Integer', cdRegister);
  end;
end;
...
begin
  ...
  begin
    RegisterMethod('Procedure AddPluginBitmap1( const Caption : string; const AImageArray : TGraphicArray; AIsUnRegistered : Boolean; const ALicenseStatus : string; const ASKUName : string)', cdRegister);
    RegisterMethod('Procedure AddProductBitmap1( const Caption : string; const AImageArray : TGraphicArray; AIsUnRegistered : Boolean; const ALicenseStatus : string; const ASKUName : string)', cdRegister);
  end;
end;
...
procedure SIRegister_INTAIDEInsightService(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'INTAIDEInsightService180', 'INTAIDEInsightService') do
  with CL.AddInterface(CL.FindInterface('INTAIDEInsightService180'),INTAIDEInsightService, 'INTAIDEInsightService') do
  begin
    RegisterMethod('Function GetToolBar : TToolBar', cdRegister);
    RegisterMethod('Procedure SetToolBar( Value : TToolBar)', cdRegister);
    RegisterMethod('Function GetEditSearchControl : TWinControl', cdRegister);
    RegisterMethod('Procedure SetEditSearchControl( Value : TWinControl)', cdRegister);
    RegisterMethod('Procedure Filter( const FilterText : string)', cdRegister);
    RegisterMethod('Procedure HidePopup', cdRegister);
    RegisterMethod('Procedure DoKey( var Key : Word)', cdRegister);
  end;
end;
...
procedure SIRegister_INTAIDEInsightService180(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IUNKNOWN', 'INTAIDEInsightService180') do
  with CL.AddInterface(CL.FindInterface('IUNKNOWN'),INTAIDEInsightService180, 'INTAIDEInsightService180') do
  begin
...
procedure SIRegister_INTACustomEditorSubView190(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'INTACustomEditorSubView', 'INTACustomEditorSubView190') do
  with CL.AddInterface(CL.FindInterface('INTACustomEditorSubView'),INTACustomEditorSubView190, 'INTACustomEditorSubView190') do
  begin
    RegisterMethod('Procedure SetViewContext( const AContext : IInterface; const AViewObject : TObject; const AViewContext : TObject)', cdRegister);
  end;
end;
...
procedure SIRegister_INTAToolbarStreamNotifier190(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'INTAToolbarStreamNotifier', 'INTAToolbarStreamNotifier190') do
  with CL.AddInterface(CL.FindInterface('INTAToolbarStreamNotifier'),INTAToolbarStreamNotifier190, 'INTAToolbarStreamNotifier190') do
  begin
    RegisterMethod('Procedure BeforeLoad( Toolbar : TWinControl)', cdRegister);
  end;
end;
...
procedure SIRegister_INTACustomizeToolbarNotifier190(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'INTACustomizeToolbarNotifier', 'INTACustomizeToolbarNotifier190') do
  with CL.AddInterface(CL.FindInterface('INTACustomizeToolbarNotifier'),INTACustomizeToolbarNotifier190, 'INTACustomizeToolbarNotifier190') do
  begin
    RegisterMethod('Procedure CancelMode', cdRegister);
  end;
end;
...
procedure SIRegister_IOTAPackageServices210(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAPackageServices140', 'IOTAPackageServices210') do
  with CL.AddInterface(CL.FindInterface('IOTAPackageServices140'),IOTAPackageServices210, 'IOTAPackageServices210') do
  begin
...
procedure SIRegister_IOTASourceEditor180(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTASourceEditor70', 'IOTASourceEditor180') do
  with CL.AddInterface(CL.FindInterface('IOTASourceEditor70'),IOTASourceEditor180, 'IOTASourceEditor180') do
  begin
...
begin
  ...
  begin
    ...
    RegisterMethod('Procedure InsertLine( LineNumber : Integer; const Buffer : UTF8String)', cdRegister);
    ...
    RegisterMethod('Procedure ReplaceLine( LineNumber : Integer; const Buffer : UTF8String)', cdRegister);
  end;
end;
...
begin
 ...
 CL.AddConstantN('sIDEInsightToolbar','String').SetString( 'IDEInsightToolBar');
 CL.AddConstantN('sPlatformDeviceToolbar','String').SetString( 'PlatformDeviceToolBar');
 ...
 CL.AddConstantN('sCategoryDelphiWindows','String').SetString( 'Borland.Delphi.Windows');
 CL.AddConstantN('sCategoryDelphiMultiDevice','String').SetString( 'Borland.Delphi.MultiDevice');
 CL.AddConstantN('sCategoryDelphiRADServer','String').SetString( 'Borland.Delphi.RADServer');
 ...
 CL.AddConstantN('cEdMenuCatLast','String').SetString( 'Last');
  ...
  SIRegister_IOTASourceEditor180(CL);
  ...
  SIRegister_IOTARepositoryWizard260(CL);
  ...
  SIRegister_IOTAPackageServices210(CL);
  ...
  SIRegister_INTACustomizeToolbarNotifier190(CL);
  SIRegister_INTAToolbarStreamNotifier(CL);
  SIRegister_INTAToolbarStreamNotifier190(CL);
  ...
  SIRegister_INTACustomEditorSubView190(CL);
  ...
  SIRegister_INTAIDEInsightService180(CL);
