...
procedure SIRegister_IOTAPersonalityServices(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IInterface', 'IOTAPersonalityServices') do
  with CL.AddInterface(CL.FindInterface('IInterface'),IOTAPersonalityServices, 'IOTAPersonalityServices') do
  begin
...
procedure SIRegister_IOTACodeInsightManager90(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTACodeInsightManager', 'IOTACodeInsightManager90') do
  with CL.AddInterface(CL.FindInterface('IOTACodeInsightManager'),IOTACodeInsightManager90, 'IOTACodeInsightManager90') do
  begin
...
procedure SIRegister_IOTAServices(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAServices70', 'IOTAServices') do
  with CL.AddInterface(CL.FindInterface('IOTAServices70'),IOTAServices, 'IOTAServices') do
  begin
...
procedure SIRegister_INTAServices(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'INTAServices70', 'INTAServices') do
  with CL.AddInterface(CL.FindInterface('INTAServices70'),INTAServices, 'INTAServices') do
  begin
...
procedure SIRegister_IOTAMessageGroup(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAMessageGroup80', 'IOTAMessageGroup') do
  with CL.AddInterface(CL.FindInterface('IOTAMessageGroup80'),IOTAMessageGroup, 'IOTAMessageGroup') do
  begin
...
procedure SIRegister_IOTAProcess(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAProcess70', 'IOTAProcess') do
  with CL.AddInterface(CL.FindInterface('IOTAProcess70'),IOTAProcess, 'IOTAProcess') do
  begin
...
procedure SIRegister_IOTAProcessModule(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAProcessModule80', 'IOTAProcessModule') do
  with CL.AddInterface(CL.FindInterface('IOTAProcessModule80'),IOTAProcessModule, 'IOTAProcessModule') do
  begin
...
procedure SIRegister_IOTAThread(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAThread70', 'IOTAThread') do
  with CL.AddInterface(CL.FindInterface('IOTAThread70'),IOTAThread, 'IOTAThread') do
  begin
...
procedure SIRegister_IOTAProject(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAProject70', 'IOTAProject') do
  with CL.AddInterface(CL.FindInterface('IOTAProject70'),IOTAProject, 'IOTAProject') do
  begin
