...
begin
  ...
  CL.AddTypeS('TCnCompiler', '( cnDelphi5, cnDelphi6, cnDelphi7, cnDelphi8, cnDelphi2005, '
    ...
    + 'cnDelphi101B, cnDelphi102T, cnDelphi103R, cnDelphi104D, cnBCB5, cnBCB6 )');
  ...
  CL.AddConstantN('_DELPHI104_DENALI', 'Boolean').SetUInt(Ord(_DELPHI104_DENALI));
  ...
  CL.AddConstantN('_DELPHI104_DENALI_UP', 'Boolean').SetUInt(Ord(_DELPHI104_DENALI_UP));
  ...
  CL.AddConstantN('_BCB104_DENALI', 'Boolean').SetUInt(Ord(_BCB104_DENALI));
  ...
  CL.AddConstantN('_BCB104_DENALI_UP', 'Boolean').SetUInt(Ord(_BCB104_DENALI_UP));
