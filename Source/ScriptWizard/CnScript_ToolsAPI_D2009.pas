...
procedure SIRegister_IOTAThread(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAThread110', 'IOTAThread') do
  with CL.AddInterface(CL.FindInterface('IOTAThread110'),IOTAThread, 'IOTAThread') do
  begin
...
procedure SIRegister_IOTAProject(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAProject100', 'IOTAProject') do
  with CL.AddInterface(CL.FindInterface('IOTAProject100'),IOTAProject, 'IOTAProject') do
  begin
