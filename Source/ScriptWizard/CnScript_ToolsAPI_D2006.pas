...
begin
  ...
  begin
    ...
    RegisterMethod('Function Evaluate1( const ExprStr : string; ResultStr : PChar; ResultStrSize : LongWord;' + 
      ' out CanModify : Boolean; SideEffects : TOTAEvalSideEffects; FormatSpecifiers : PChar; out ResultAddr : LongWord; out ResultSize, ResultVal : LongWord; FileName : string; LineNumber : Integer) : TOTAEvaluateResult', cdRegister);
    RegisterMethod('Function GetDisplayString : string', cdRegister);
    RegisterMethod('Function GetLocationString : string', cdRegister);
...
begin
  ...
  begin
    ...
    RegisterMethod('Function Evaluate( const ExprStr : string; ResultStr : PChar; ResultStrSize : LongWord;' + 
      ' out CanModify : Boolean; AllowSideEffects : Boolean; FormatSpecifiers : PChar; out ResultAddr : LongWord; out ResultSize, ResultVal : LongWord) : TOTAEvaluateResult', cdRegister);
...
procedure SIRegister_IOTASyncEditPoint(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IUNKNOWN', 'IOTASyncEditPoint') do
  with CL.AddInterface(CL.FindInterface('IUNKNOWN'),IOTASyncEditPoint, 'IOTASyncEditPoint') do
  begin
