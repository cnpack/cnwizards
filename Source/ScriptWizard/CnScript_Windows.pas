...
begin
  ...
  CL.AddConstantN('MEM_IMAGE','').SetUInt($1000000);
  ...
  CL.AddConstantN('MAILSLOT_NO_MESSAGE','LongInt').SetUInt( LongWord ( - 1 ));
  CL.AddConstantN('MAILSLOT_WAIT_FOREVER','LongInt').SetUInt( LongWord ( - 1 ));
  ...
  CL.AddConstantN('STANDARD_RIGHTS_READ','').SetUInt( $00020000);
  CL.AddConstantN('STANDARD_RIGHTS_WRITE','').SetUInt( $00020000);
  CL.AddConstantN('STANDARD_RIGHTS_EXECUTE','').SetUInt( $00020000);
  ...
  CL.AddConstantN('SECURITY_MAX_IMPERSONATION_LEVEL','').SetInt( 3);
  CL.AddConstantN('DEFAULT_IMPERSONATION_LEVEL','').SetInt( 2);
  ...
  CL.AddConstantN('TOKEN_EXECUTE','').SetUInt( $00020000);
  ...
  CL.AddConstantN('HFILE_ERROR','LongInt').SetUInt( LongWord ( - 1 ));
  ...
  CL.AddConstantN('WAIT_TIMEOUT','').SetUInt( $00000102);
  CL.AddConstantN('WAIT_IO_COMPLETION','').SetUInt( $000000C0);
  CL.AddConstantN('STILL_ACTIVE','').SetUInt( STATUS_PENDING);
  CL.AddConstantN('EXCEPTION_ACCESS_VIOLATION','').SetUInt( STATUS_ACCESS_VIOLATION);
  CL.AddConstantN('EXCEPTION_DATATYPE_MISALIGNMENT','').SetUInt( STATUS_DATATYPE_MISALIGNMENT);
  CL.AddConstantN('EXCEPTION_BREAKPOINT','').SetUInt( STATUS_BREAKPOINT);
  CL.AddConstantN('EXCEPTION_SINGLE_STEP','').SetUInt( STATUS_SINGLE_STEP);
  CL.AddConstantN('EXCEPTION_ARRAY_BOUNDS_EXCEEDED','').SetUInt( STATUS_ARRAY_BOUNDS_EXCEEDED);
  CL.AddConstantN('EXCEPTION_FLT_DENORMAL_OPERAND','').SetUInt( STATUS_FLOAT_DENORMAL_OPERAND);
  CL.AddConstantN('EXCEPTION_FLT_DIVIDE_BY_ZERO','').SetUInt( STATUS_FLOAT_DIVIDE_BY_ZERO);
  CL.AddConstantN('EXCEPTION_FLT_INEXACT_RESULT','').SetUInt( STATUS_FLOAT_INEXACT_RESULT);
  CL.AddConstantN('EXCEPTION_FLT_INVALID_OPERATION','').SetUInt( STATUS_FLOAT_INVALID_OPERATION);
  CL.AddConstantN('EXCEPTION_FLT_OVERFLOW','').SetUInt( STATUS_FLOAT_OVERFLOW);
  CL.AddConstantN('EXCEPTION_FLT_STACK_CHECK','').SetUInt( STATUS_FLOAT_STACK_CHECK);
  CL.AddConstantN('EXCEPTION_FLT_UNDERFLOW','').SetUInt( STATUS_FLOAT_UNDERFLOW);
  CL.AddConstantN('EXCEPTION_INT_DIVIDE_BY_ZERO','').SetUInt( STATUS_INTEGER_DIVIDE_BY_ZERO);
  CL.AddConstantN('EXCEPTION_INT_OVERFLOW','').SetUInt( STATUS_INTEGER_OVERFLOW);
  CL.AddConstantN('EXCEPTION_PRIV_INSTRUCTION','').SetUInt( STATUS_PRIVILEGED_INSTRUCTION);
  CL.AddConstantN('EXCEPTION_IN_PAGE_ERROR','').SetUInt( STATUS_IN_PAGE_ERROR);
  CL.AddConstantN('EXCEPTION_ILLEGAL_INSTRUCTION','').SetUInt( STATUS_ILLEGAL_INSTRUCTION);
  CL.AddConstantN('EXCEPTION_NONCONTINUABLE_EXCEPTION','').SetUInt( STATUS_NONCONTINUABLE_EXCEPTION);
  CL.AddConstantN('EXCEPTION_STACK_OVERFLOW','').SetUInt( STATUS_STACK_OVERFLOW);
  CL.AddConstantN('EXCEPTION_INVALID_DISPOSITION','').SetUInt( STATUS_INVALID_DISPOSITION);
  CL.AddConstantN('EXCEPTION_GUARD_PAGE','').SetUInt( STATUS_GUARD_PAGE_VIOLATION);
  CL.AddConstantN('EXCEPTION_INVALID_HANDLE','').SetUInt( STATUS_INVALID_HANDLE);
  CL.AddConstantN('CONTROL_C_EXIT','').SetUInt( STATUS_CONTROL_C_EXIT);
  ...
  CL.AddConstantN('MUTEX_MODIFY_STATE','').SetUInt( MUTANT_QUERY_STATE);
  CL.AddConstantN('MUTEX_ALL_ACCESS','').SetUInt( MUTANT_ALL_ACCESS);
  ...
  CL.AddConstantN('GMEM_LOWER','').SetUInt( GMEM_NOT_BANKED);
  ...
  CL.AddConstantN('NONZEROLPTR','').SetUInt( LMEM_FIXED);
  ...
  CL.AddConstantN('THREAD_PRIORITY_LOWEST','').SetInt( THREAD_BASE_PRIORITY_MIN);
  ...
  CL.AddConstantN('THREAD_PRIORITY_HIGHEST','').SetInt( THREAD_BASE_PRIORITY_MAX);
  CL.AddConstantN('THREAD_PRIORITY_ABOVE_NORMAL','LongInt').SetInt( THREAD_PRIORITY_HIGHEST - 1);
  CL.AddConstantN('THREAD_PRIORITY_ERROR_RETURN','').SetInt( MAXLONG);
  CL.AddConstantN('THREAD_PRIORITY_TIME_CRITICAL','').SetInt( THREAD_BASE_PRIORITY_LOWRT);
  CL.AddConstantN('THREAD_PRIORITY_IDLE','').SetInt( THREAD_BASE_PRIORITY_IDLE);
  ...
  CL.AddConstantN('STD_INPUT_HANDLE','LongInt').SetUInt( DWORD ( - 10 ));
  CL.AddConstantN('STD_OUTPUT_HANDLE','LongInt').SetUInt( DWORD ( - 11 ));
  CL.AddConstantN('STD_ERROR_HANDLE','LongInt').SetUInt( DWORD ( - 12 ));
  ...
  CL.AddConstantN('IE_BADID','LongInt').SetUInt( LongWord ( - 1 ));
  CL.AddConstantN('IE_OPEN','LongInt').SetUInt( LongWord ( - 2 ));
  CL.AddConstantN('IE_NOPEN','LongInt').SetUInt( LongWord ( - 3 ));
  CL.AddConstantN('IE_MEMORY','LongInt').SetUInt( LongWord ( - 4 ));
  CL.AddConstantN('IE_DEFAULT','LongInt').SetUInt( LongWord ( - 5 ));
  CL.AddConstantN('IE_HARDWARE','LongInt').SetUInt( LongWord ( - 10 ));
  CL.AddConstantN('IE_BYTESIZE','LongInt').SetUInt( LongWord ( - 11 ));
  CL.AddConstantN('IE_BAUDRATE','LongInt').SetUInt( LongWord ( - 12 ));
  ...
  CL.AddConstantN('S_SERDVNA','LongInt').SetUInt( LongWord ( - 1 ));
  CL.AddConstantN('S_SEROFM','LongInt').SetUInt( LongWord ( - 2 ));
  CL.AddConstantN('S_SERMACT','LongInt').SetUInt( LongWord ( - 3 ));
  CL.AddConstantN('S_SERQFUL','LongInt').SetUInt( LongWord ( - 4 ));
  CL.AddConstantN('S_SERBDNT','LongInt').SetUInt( LongWord ( - 5 ));
  CL.AddConstantN('S_SERDLN','LongInt').SetUInt( LongWord ( - 6 ));
  CL.AddConstantN('S_SERDCC','LongInt').SetUInt( LongWord ( - 7 ));
  CL.AddConstantN('S_SERDTP','LongInt').SetUInt( LongWord ( - 8 ));
  CL.AddConstantN('S_SERDVL','LongInt').SetUInt( LongWord ( - 9 ));
  CL.AddConstantN('S_SERDMD','LongInt').SetUInt( LongWord ( - 10 ));
  CL.AddConstantN('S_SERDSH','LongInt').SetUInt( LongWord ( - 11 ));
  CL.AddConstantN('S_SERDPT','LongInt').SetUInt( LongWord ( - 12 ));
  CL.AddConstantN('S_SERDFQ','LongInt').SetUInt( LongWord ( - 13 ));
  CL.AddConstantN('S_SERDDR','LongInt').SetUInt( LongWord ( - 14 ));
  CL.AddConstantN('S_SERDSR','LongInt').SetUInt( LongWord ( - 15 ));
  CL.AddConstantN('S_SERDST','LongInt').SetUInt( LongWord ( - 16 ));
  ...
  CL.AddConstantN('FS_CASE_IS_PRESERVED','').SetUInt( FILE_CASE_PRESERVED_NAMES);
  CL.AddConstantN('FS_CASE_SENSITIVE','').SetUInt( FILE_CASE_SENSITIVE_SEARCH);
  CL.AddConstantN('FS_UNICODE_STORED_ON_DISK','').SetUInt( FILE_UNICODE_ON_DISK);
  CL.AddConstantN('FS_PERSISTENT_ACLS','').SetUInt( FILE_PERSISTENT_ACLS);
  CL.AddConstantN('FS_VOL_IS_COMPRESSED','').SetUInt( FILE_VOLUME_IS_COMPRESSED);
  CL.AddConstantN('FS_FILE_COMPRESSION','').SetUInt( FILE_FILE_COMPRESSION);
  CL.AddConstantN('FILE_MAP_COPY','').SetUInt( SECTION_QUERY);
  CL.AddConstantN('FILE_MAP_WRITE','').SetUInt( SECTION_MAP_WRITE);
  CL.AddConstantN('FILE_MAP_READ','').SetUInt( SECTION_MAP_READ);
  CL.AddConstantN('FILE_MAP_ALL_ACCESS','').SetUInt( SECTION_ALL_ACCESS);
  ...
  CL.AddConstantN('RGN_ERROR','').SetInt( ERROR);
  ...
  CL.AddConstantN('RGN_MIN','').SetInt( RGN_AND);
  CL.AddConstantN('RGN_MAX','').SetInt( RGN_COPY);
  ...
  CL.AddConstantN('STRETCH_ANDSCANS','').SetInt( BLACKONWHITE);
  CL.AddConstantN('STRETCH_ORSCANS','').SetInt( WHITEONBLACK);
  CL.AddConstantN('STRETCH_DELETESCANS','').SetInt( COLORONCOLOR);
  CL.AddConstantN('STRETCH_HALFTONE','').SetInt( HALFTONE);
  ...
  CL.AddConstantN('VTA_BASELINE','').SetInt( TA_BASELINE);
  CL.AddConstantN('VTA_LEFT','').SetInt( TA_BOTTOM);
  CL.AddConstantN('VTA_RIGHT','').SetInt( TA_TOP);
  CL.AddConstantN('VTA_CENTER','').SetInt( TA_CENTER);
  CL.AddConstantN('VTA_BOTTOM','').SetInt( TA_RIGHT);
  CL.AddConstantN('VTA_TOP','').SetInt( TA_LEFT);
  ...
  CL.AddConstantN('DCB_DIRTY','').SetInt( DCB_ACCUMULATE);
  ...
  CL.AddConstantN('SP_ERROR','LongInt').SetUInt( LongWord ( - 1 ));
  CL.AddConstantN('SP_APPABORT','LongInt').SetUInt( LongWord ( - 2 ));
  CL.AddConstantN('SP_USERABORT','LongInt').SetUInt( LongWord ( - 3 ));
  CL.AddConstantN('SP_OUTOFDISK','LongInt').SetUInt( LongWord ( - 4 ));
  CL.AddConstantN('SP_OUTOFMEMORY','LongInt').SetUInt( LongWord ( - 5 ));
  ...
  CL.AddConstantN('MWT_MIN','').SetInt( MWT_IDENTITY);
  CL.AddConstantN('MWT_MAX','').SetInt( MWT_RIGHTMULTIPLY);
  ...
  CL.AddConstantN('FW_ULTRALIGHT','').SetInt( FW_EXTRALIGHT);
  CL.AddConstantN('FW_REGULAR','').SetInt( FW_NORMAL);
  CL.AddConstantN('FW_DEMIBOLD','').SetInt( FW_SEMIBOLD);
  CL.AddConstantN('FW_ULTRABOLD','').SetInt( FW_EXTRABOLD);
  CL.AddConstantN('FW_BLACK','').SetInt( FW_HEAVY);
  ...
  CL.AddConstantN('MM_MIN','').SetInt( MM_TEXT);
  CL.AddConstantN('MM_MAX','').SetInt( MM_ANISOTROPIC);
  CL.AddConstantN('MM_MAX_FIXEDSCALE','').SetInt( MM_TWIPS);
  ...
  CL.AddConstantN('HOLLOW_BRUSH','').SetInt( NULL_BRUSH);
  ...
  CL.AddConstantN('BS_HOLLOW','').SetInt( BS_NULL);
  ...
  CL.AddConstantN('DMPAPER_FIRST','').SetInt( DMPAPER_LETTER);
  ...
  CL.AddConstantN('DMPAPER_LAST','').SetInt( DMPAPER_PENV_10_ROTATED);
  CL.AddConstantN('DMPAPER_USER','LongWord').SetUInt( $100);
  CL.AddConstantN('DMBIN_UPPER','LongInt').SetInt( 1);
  CL.AddConstantN('DMBIN_FIRST','').SetInt( DMBIN_UPPER);
  ...
  CL.AddConstantN('DMBIN_LAST','').SetInt( DMBIN_FORMSOURCE);
  CL.AddConstantN('DMBIN_USER','LongWord').SetUInt( $100);
  CL.AddConstantN('DMRES_DRAFT','LongInt').SetUInt( LongWord ( - 1 ));
  CL.AddConstantN('DMRES_LOW','LongInt').SetUInt( LongWord ( - 2 ));
  CL.AddConstantN('DMRES_MEDIUM','LongInt').SetUInt( LongWord ( - 3 ));
  CL.AddConstantN('DMRES_HIGH','LongInt').SetUInt( LongWord ( - 4 ));
  ...
  CL.AddConstantN('PFD_UNDERLAY_PLANE','LongInt').SetUInt( LongWord ( - 1 ));
  ...
  CL.AddConstantN('DM_IN_BUFFER','').SetInt( DM_MODIFY);
  CL.AddConstantN('DM_IN_PROMPT','').SetInt( DM_PROMPT);
  CL.AddConstantN('DM_OUT_BUFFER','').SetInt( DM_COPY);
  CL.AddConstantN('DM_OUT_DEFAULT','').SetInt( DM_UPDATE);
  ...
  CL.AddConstantN('ILLUMINANT_MAX_INDEX','').SetInt( ILLUMINANT_F2);
  CL.AddConstantN('ILLUMINANT_TUNGSTEN','').SetInt( ILLUMINANT_A);
  CL.AddConstantN('ILLUMINANT_DAYLIGHT','').SetInt( ILLUMINANT_C);
  CL.AddConstantN('ILLUMINANT_FLUORESCENT','').SetInt( ILLUMINANT_F2);
  CL.AddConstantN('ILLUMINANT_NTSC','').SetInt( ILLUMINANT_C);
  ...
  CL.AddConstantN('WH_MINHOOK','').SetInt( WH_MIN);
  CL.AddConstantN('WH_MAXHOOK','').SetInt( WH_MAX);
  ...
  CL.AddConstantN('HC_NOREM','').SetInt( HC_NOREMOVE);
  ...
  CL.AddConstantN('WHEEL_PAGESCROLL','').SetUInt( MAXDWORD);
  ...
  CL.AddConstantN('HTSIZE','').SetInt( HTGROWBOX);
  ...
  CL.AddConstantN('HTREDUCE','').SetInt( HTMINBUTTON);
  CL.AddConstantN('HTZOOM','').SetInt( HTMAXBUTTON);
  CL.AddConstantN('HTSIZEFIRST','').SetInt( HTLEFT);
  CL.AddConstantN('HTSIZELAST','').SetInt( HTBOTTOMRIGHT);
  ...
  CL.AddConstantN('SIZENORMAL','').SetInt( SIZE_RESTORED);
  CL.AddConstantN('SIZEICONIC','').SetInt( SIZE_MINIMIZED);
  CL.AddConstantN('SIZEFULLSCREEN','').SetInt( SIZE_MAXIMIZED);
  CL.AddConstantN('SIZEZOOMSHOW','').SetInt( SIZE_MAXSHOW);
  CL.AddConstantN('SIZEZOOMHIDE','').SetInt( SIZE_MAXHIDE);
  ...
  CL.AddConstantN('WS_TILED','').SetInt( WS_OVERLAPPED);
  CL.AddConstantN('WS_ICONIC','').SetInt( WS_MINIMIZE);
  CL.AddConstantN('WS_SIZEBOX','').SetInt( WS_THICKFRAME);
  CL.AddConstantN('WS_TILEDWINDOW','').SetInt( WS_OVERLAPPEDWINDOW);
  ...
  CL.AddConstantN('wnd_Broadcast','').SetInt( HWND_BROADCAST);
  CL.AddConstantN('HWND_MESSAGE','LongInt').SetInt( - 3);
  CL.AddConstantN('wnd_Message','').SetInt( HWND_MESSAGE);
  ...
  CL.AddConstantN('SWP_DRAWFRAME','').SetInt( SWP_FRAMECHANGED);
  CL.AddConstantN('SWP_NOREPOSITION','').SetInt( SWP_NOOWNERZORDER);
  ...
  CL.AddConstantN('HWND_TOPMOST','LongInt').SetUInt( LongWord ( - 1 ));
  CL.AddConstantN('HWND_NOTOPMOST','LongInt').SetUInt( LongWord ( - 2 ));
  ...
  CL.AddConstantN('SM_CXFIXEDFRAME','').SetInt( SM_CXDLGFRAME);
  CL.AddConstantN('SM_CYFIXEDFRAME','').SetInt( SM_CYDLGFRAME);
  CL.AddConstantN('SM_CXSIZEFRAME','').SetInt( SM_CXFRAME);
  CL.AddConstantN('SM_CYSIZEFRAME','').SetInt( SM_CYFRAME);
  ...
  CL.AddConstantN('ESB_DISABLE_LTUP','').SetInt( ESB_DISABLE_LEFT);
  CL.AddConstantN('ESB_DISABLE_RTDN','').SetInt( ESB_DISABLE_RIGHT);
  ...
  CL.AddConstantN('COLOR_ENDCOLORS','').SetInt( COLOR_GRADIENTINACTIVECAPTION);
  CL.AddConstantN('COLOR_DESKTOP','').SetInt( COLOR_BACKGROUND);
  CL.AddConstantN('COLOR_3DFACE','').SetInt( COLOR_BTNFACE);
  CL.AddConstantN('COLOR_3DSHADOW','').SetInt( COLOR_BTNSHADOW);
  CL.AddConstantN('COLOR_3DHIGHLIGHT','').SetInt( COLOR_BTNHIGHLIGHT);
  CL.AddConstantN('COLOR_3DHILIGHT','').SetInt( COLOR_BTNHIGHLIGHT);
  CL.AddConstantN('COLOR_BTNHILIGHT','').SetInt( COLOR_BTNHIGHLIGHT);
  ...
  CL.AddConstantN('MFT_STRING','').SetInt( MF_STRING);
  CL.AddConstantN('MFT_BITMAP','').SetInt( MF_BITMAP);
  CL.AddConstantN('MFT_MENUBARBREAK','').SetInt( MF_MENUBARBREAK);
  CL.AddConstantN('MFT_MENUBREAK','').SetInt( MF_MENUBREAK);
  CL.AddConstantN('MFT_OWNERDRAW','').SetInt( MF_OWNERDRAW);
  CL.AddConstantN('MFT_RADIOCHECK','LongWord').SetUInt( $200);
  CL.AddConstantN('MFT_SEPARATOR','').SetInt( MF_SEPARATOR);
  CL.AddConstantN('MFT_RIGHTORDER','LongWord').SetUInt( $2000);
  CL.AddConstantN('MFT_RIGHTJUSTIFY','').SetInt( MF_RIGHTJUSTIFY);
  CL.AddConstantN('MFS_GRAYED','LongInt').SetInt( 3);
  CL.AddConstantN('MFS_DISABLED','').SetInt( MFS_GRAYED);
  CL.AddConstantN('MFS_CHECKED','').SetInt( MF_CHECKED);
  CL.AddConstantN('MFS_HILITE','').SetInt( MF_HILITE);
  CL.AddConstantN('MFS_ENABLED','').SetInt( MF_ENABLED);
  CL.AddConstantN('MFS_UNCHECKED','').SetInt( MF_UNCHECKED);
  CL.AddConstantN('MFS_UNHILITE','').SetInt( MF_UNHILITE);
  CL.AddConstantN('MFS_DEFAULT','').SetInt( MF_DEFAULT);
  ...
  CL.AddConstantN('SC_ICON','').SetInt( SC_MINIMIZE);
  CL.AddConstantN('SC_ZOOM','').SetInt( SC_MAXIMIZE);
  ...
  CL.AddConstantN('OIC_WARNING','').SetInt( OIC_BANG);
  CL.AddConstantN('OIC_ERROR','').SetInt( OIC_HAND);
  CL.AddConstantN('OIC_INFORMATION','').SetInt( OIC_NOTE);
  ...
  CL.AddConstantN('IDI_WARNING','').SetInt( 32515);
  CL.AddConstantN('IDI_ERROR','').SetInt( 32513);
  CL.AddConstantN('IDI_INFORMATION','').SetInt( 32516);
  CL.AddConstantN('IDOK','LongInt').SetInt( 1);
  CL.AddConstantN('ID_OK','').SetInt( IDOK);
  CL.AddConstantN('IDCANCEL','LongInt').SetInt( 2);
  CL.AddConstantN('ID_CANCEL','').SetInt( IDCANCEL);
  CL.AddConstantN('IDABORT','LongInt').SetInt( 3);
  CL.AddConstantN('ID_ABORT','').SetInt( IDABORT);
  CL.AddConstantN('IDRETRY','LongInt').SetInt( 4);
  CL.AddConstantN('ID_RETRY','').SetInt( IDRETRY);
  CL.AddConstantN('IDIGNORE','LongInt').SetInt( 5);
  CL.AddConstantN('ID_IGNORE','').SetInt( IDIGNORE);
  CL.AddConstantN('IDYES','LongInt').SetInt( 6);
  CL.AddConstantN('ID_YES','').SetInt( IDYES);
  CL.AddConstantN('IDNO','LongInt').SetInt( 7);
  CL.AddConstantN('ID_NO','').SetInt( IDNO);
  CL.AddConstantN('IDCLOSE','LongInt').SetInt( 8);
  CL.AddConstantN('ID_CLOSE','').SetInt( IDCLOSE);
  CL.AddConstantN('IDHELP','LongInt').SetInt( 9);
  CL.AddConstantN('ID_HELP','').SetInt( IDHELP);
  ...
  CL.AddConstantN('BS_RIGHTBUTTON','').SetInt( BS_LEFTTEXT);
  ...
  CL.AddConstantN('SPIF_SENDCHANGE','').SetInt( SPIF_SENDWININICHANGE);
  CL.AddConstantN('METRICS_USEDEFAULT','LongInt').SetUInt( LongWord ( - 1 ));
  ...
  CL.AddConstantN('VS_FILE_INFO','').SetInt( 16);
  ...
  CL.AddConstantN('WN_SUCCESS','').SetInt( NO_ERROR);
  CL.AddConstantN('WN_NO_ERROR','').SetInt( NO_ERROR);
  CL.AddConstantN('WN_NOT_SUPPORTED','').SetInt( ERROR_NOT_SUPPORTED);
  CL.AddConstantN('WN_CANCEL','').SetInt( ERROR_CANCELLED);
  CL.AddConstantN('WN_RETRY','').SetInt( ERROR_RETRY);
  CL.AddConstantN('WN_NET_ERROR','').SetInt( ERROR_UNEXP_NET_ERR);
  CL.AddConstantN('WN_MORE_DATA','').SetInt( ERROR_MORE_DATA);
  CL.AddConstantN('WN_BAD_POINTER','').SetInt( ERROR_INVALID_ADDRESS);
  CL.AddConstantN('WN_BAD_VALUE','').SetInt( ERROR_INVALID_PARAMETER);
  CL.AddConstantN('WN_BAD_USER','').SetInt( ERROR_BAD_USERNAME);
  CL.AddConstantN('WN_BAD_PASSWORD','').SetInt( ERROR_INVALID_PASSWORD);
  CL.AddConstantN('WN_ACCESS_DENIED','').SetInt( ERROR_ACCESS_DENIED);
  CL.AddConstantN('WN_FUNCTION_BUSY','').SetInt( ERROR_BUSY);
  CL.AddConstantN('WN_WINDOWS_ERROR','').SetInt( ERROR_UNEXP_NET_ERR);
  CL.AddConstantN('WN_OUT_OF_MEMORY','').SetInt( ERROR_NOT_ENOUGH_MEMORY);
  CL.AddConstantN('WN_NO_NETWORK','').SetInt( ERROR_NO_NETWORK);
  CL.AddConstantN('WN_EXTENDED_ERROR','').SetInt( ERROR_EXTENDED_ERROR);
  CL.AddConstantN('WN_BAD_LEVEL','').SetInt( ERROR_INVALID_LEVEL);
  CL.AddConstantN('WN_BAD_HANDLE','').SetInt( ERROR_INVALID_HANDLE);
  CL.AddConstantN('WN_NOT_INITIALIZING','').SetInt( ERROR_ALREADY_INITIALIZED);
  CL.AddConstantN('WN_NO_MORE_DEVICES','').SetInt( ERROR_NO_MORE_DEVICES);
  CL.AddConstantN('WN_NOT_CONNECTED','').SetInt( ERROR_NOT_CONNECTED);
  CL.AddConstantN('WN_OPEN_FILES','').SetInt( ERROR_OPEN_FILES);
  CL.AddConstantN('WN_DEVICE_IN_USE','').SetInt( ERROR_DEVICE_IN_USE);
  CL.AddConstantN('WN_BAD_NETNAME','').SetInt( ERROR_BAD_NET_NAME);
  CL.AddConstantN('WN_BAD_LOCALNAME','').SetInt( ERROR_BAD_DEVICE);
  CL.AddConstantN('WN_ALREADY_CONNECTED','').SetInt( ERROR_ALREADY_ASSIGNED);
  CL.AddConstantN('WN_DEVICE_ERROR','').SetInt( ERROR_GEN_FAILURE);
  CL.AddConstantN('WN_CONNECTION_CLOSED','').SetInt( ERROR_CONNECTION_UNAVAIL);
  CL.AddConstantN('WN_NO_NET_OR_BAD_PATH','').SetInt( ERROR_NO_NET_OR_BAD_PATH);
  CL.AddConstantN('WN_BAD_PROVIDER','').SetInt( ERROR_BAD_PROVIDER);
  CL.AddConstantN('WN_CANNOT_OPEN_PROFILE','').SetInt( ERROR_CANNOT_OPEN_PROFILE);
  CL.AddConstantN('WN_BAD_PROFILE','').SetInt( ERROR_BAD_PROFILE);
  CL.AddConstantN('WN_BAD_DEV_TYPE','').SetInt( ERROR_BAD_DEV_TYPE);
  CL.AddConstantN('WN_DEVICE_ALREADY_REMEMBERED','').SetInt( ERROR_DEVICE_ALREADY_REMEMBERED);
  CL.AddConstantN('WN_NO_MORE_ENTRIES','').SetInt( ERROR_NO_MORE_ITEMS);
  CL.AddConstantN('WN_NOT_CONTAINER','').SetInt( ERROR_NOT_CONTAINER);
  CL.AddConstantN('WN_NOT_AUTHENTICATED','').SetInt( ERROR_NOT_AUTHENTICATED);
  CL.AddConstantN('WN_NOT_LOGGED_ON','').SetInt( ERROR_NOT_LOGGED_ON);
  CL.AddConstantN('WN_NOT_VALIDATED','').SetInt( ERROR_NO_LOGON_SERVERS);
  ...
  CL.AddConstantN('WM_DDE_INITIATE','').SetInt( WM_DDE_FIRST);
