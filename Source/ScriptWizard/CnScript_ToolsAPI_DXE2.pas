...
procedure SIRegister_IOTAProject(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAProject150', 'IOTAProject') do
  with CL.AddInterface(CL.FindInterface('IOTAProject150'),IOTAProject, 'IOTAProject') do
  begin
...
begin
 ...
 CL.AddConstantN('pmmpUserBuildConfig','LongInt').SetInt( 11500000);
  ...
  CL.AddTypeS('TOTAProcessType', '( optWin32, optOSX32, optWin64 )');
