...
procedure SIRegister_IOTAServices(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAServices140', 'IOTAServices') do
  with CL.AddInterface(CL.FindInterface('IOTAServices140'),IOTAServices, 'IOTAServices') do
  begin
...
procedure SIRegister_IOTAThread(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAThread140', 'IOTAThread') do
  with CL.AddInterface(CL.FindInterface('IOTAThread140'),IOTAThread, 'IOTAThread') do
  begin
...
procedure SIRegister_IOTAProject(CL: TPSPascalCompiler);
begin
  //with RegInterfaceS(CL,'IOTAProject140', 'IOTAProject') do
  with CL.AddInterface(CL.FindInterface('IOTAProject140'),IOTAProject, 'IOTAProject') do
  begin
...
begin
 ...
 CL.AddConstantN('sFrameworkTypeUCL','String').SetString( 'UCL');
