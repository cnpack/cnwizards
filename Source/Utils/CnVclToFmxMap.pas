...
const
  ...
  VCL_FMX_PROPERTY_ENUM_PAIRS: array[0..219] of string = (
    ...
    'clSystemColor:SystemColor',
    'clScrollBar:SysScrollBar',
    'clBackground:SysBackground',
    'clActiveCaption:SysActiveCaption',
    'clInactiveCaption:SysInactiveCaption',
    'clMenu:SysMenu',
    'clWindow:SysWindow',
    'clWindowFrame:SysWindowFrame',
    'clMenuText:SysMenuText',
    'clWindowText:SysWindowText',
    'clCaptionText:SysCaptionText',
    'clActiveBorder:SysActiveBorder',
    'clInactiveBorder:SysInactiveBorder',
    'clAppWorkSpace:SysAppWorkSpace',
    'clHighlight:SysHighlight',
    'clHighlightText:SysHighlightText',
    'clBtnFace:SysBtnFace',
    'clBtnShadow:SysBtnShadow',
    'clGrayText:SysGrayText',
    'clBtnText:SysBtnText',
    'clInactiveCaptionText:SysInactiveCaptionText',
    'clBtnHighlight:SysBtnHighlight',
    'cl3DDkShadow:Sys3DDkShadow',
    'cl3DLight:Sys3DLight',
    'clInfoText:SysInfoText',
    'clInfoBk:SysInfoBk',
    'clHotLight:SysHotLight',
    'clGradientActiveCaption:SysGradientActiveCaption',
    'clGradientInactiveCaption:SysGradientInactiveCaption',
    'clMenuHighlight:SysMenuHighlight',
    'clMenuBar:SysMenuBar',
    'clBlack:Black',
    'clMaroon:Maroon',
    'clGreen:Green',
    'clOlive:Olive',
