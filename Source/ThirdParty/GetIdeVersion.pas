...
type
  TBorlandIdeVersion =
    (ideUndetected, ideUnknown,
     ...
     ideD1500,
     ideD1600,
     ideD1700, ideDXE4, ideDXE5, ideDXE6, ideDXE7, ideDXE8, ideD10S, ideD101,
     ideCSB100,
     ideBCB300, ideBCB301,
...
function GetDelphi17Version: TBorlandIdeVersion;
const
  CoreIde1700: TVersionNumber =
    (Major: 17; Minor: 0; Release: 0; Build: 0);
begin
  Result := ideD1700;
end;

function GetDelphiXE4Version: TBorlandIdeVersion;
const
  CoreIdeXE4: TVersionNumber =
    (Major: 18; Minor: 0; Release: 0; Build: 0);
begin
  Result := ideDXE4;
end;
...
function GetDelphiXE6Version: TBorlandIdeVersion;
const
  CoreIdeXE6: TVersionNumber =
    (Major: 20; Minor: 0; Release: 0; Build: 0);
begin
  Result := ideDXE6;
end;
...
function GetDelphi10SVersion: TBorlandIdeVersion;
const
  CoreIde10S: TVersionNumber =
    (Major: 23; Minor: 0; Release: 0; Build: 0);
begin
  Result := ideD10S;
end;

function GetDelphi101Version: TBorlandIdeVersion;
const
  CoreIde10S: TVersionNumber =
...
begin
  ...
  {$IFDEF VER240}  // Delphi 17 (2013)
    Result := GetDelphi17Version;
  ...
  {$IFDEF VER270}  // Delphi 20/XE6
    Result := GetDelphiXE6Version;
    Assert(Result in [ideDXE6]);
  {$ENDIF}
  ...
  {$IFDEF VER300}  // Delphi 23/10S
    Result := GetDelphi10SVersion;
    Assert(Result in [ideD10S]);
  {$ENDIF}

  {$IFDEF VER310}  // Delphi 24/10.1
    Result := GetDelphi101Version;
    Assert(Result in [ideD101]);
  {$ENDIF}
