...
{ The linkflag defines the type of file }
  AB_TAR_LF_OLDNORMAL = AnsiChar(#0);   { Normal disk file, Unix compatible }
  AB_TAR_LF_NORMAL    = AnsiChar('0');  { Normal disk file }
  AB_TAR_LF_LINK      = AnsiChar('1');  { Link to previously dumped file }
  AB_TAR_LF_SYMLINK   = AnsiChar('2');  { Symbolic link }
  AB_TAR_LF_CHR       = AnsiChar('3');  { Character special file }
  AB_TAR_LF_BLK       = AnsiChar('4');  { Block special file }
  AB_TAR_LF_DIR       = AnsiChar('5');  { Directory }
  AB_TAR_LF_FIFO      = AnsiChar('6');  { FIFO special file }
  AB_TAR_LF_CONTIG    = AnsiChar('7');  { Contiguous file }
