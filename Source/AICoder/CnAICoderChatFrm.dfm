object CnAICoderChatForm: TCnAICoderChatForm
    ...
    object pnlSend: TPanel
      ...
      object tlbSend: TToolBar
        ...
        object btnFavorite: TToolButton
          ...
          Top = 0
          Caption = 'btnFavorite'
          DropdownMenu = pmFavorite
          ImageIndex = 5
          Style = tbsDropDown
        end
        object btnAddToFavorite: TToolButton
          Left = 36
          Top = 0
          Action = actAddDraftToFavorite
        end
        object btnClearFavorite: TToolButton
          Left = 59
          Top = 0
          Action = actClearFavorite
        end
      end
    end
  end
  ...
  object pmChat: TPopupMenu
    ...
    object AddMsgtoFavorite1: TMenuItem
      Action = actAddMsgToFavorite
    end
    object N2: TMenuItem
      Caption = '-'
    end
