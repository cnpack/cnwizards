...
type
  ICnPascalFormatterIntf = interface
    ...
    procedure SetFormatRule(DirectiveMode: DWORD; KeywordStyle: DWORD; TabSpace:
    ...
    function FormatOneUnit(Input: PAnsiChar; Len: DWORD): PAnsiChar;
    {* 格式化一整个 Pascal 文件内容，代码以 AnsiString 格式传入。
       返回结果存储的 AnsiString 字符内容的指针，用完后必须释放}

    function FormatCodeBlock(StartType: DWORD; StartIndent: DWORD;
