object CnAboutForm: TCnAboutForm
  ...
  object GridPanel1: TPanel
    ...
    object Label2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Include Functions:'#13#10#13#10'1.  Analyze Contained Units of a Executabl' +
        'e File.'#13#10'2.  Analyze Required Packages of a Executable File.'#13#10'3.' +
        '  Get Contained Units of a Delphi Executable File.'#13#10'4.  Get Requ' +
        'ired packages of a Delphi Executable File.'#13#10'5.  Get Executable F' +
        'iles Depend on a Delphi Executable File.'#13#10'6.  Get Executable Fil' +
        'es Contained a Unit.'#13#10'7.  Edit Relationship of Source File and A' +
        'ffected Modules.'#13#10'8.  View Relationship of Source File and Affec' +
        'ted Modules.'#13#10
      WordWrap = True
    end
    object bvl1: TBevel
