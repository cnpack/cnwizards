...
type
  ...
  TAbiType = (atBCB5, atBCB6, atDelphi5, atDelphi6, atDelphi7, atDelphi8,
    ...
    atDelphiXE2, atDelphiXE3, atDelphiXE4);
...
begin
  ...
  begin
    ...
    else if m_AbiType in [atDelphiXE, atDelphiXE2, atDelphiXE3, atDelphiXE4] then
  ...
  begin
    if m_AbiType in [atDelphiXE, atDelphiXE2, atDelphiXE3, atDelphiXE4] then
...
begin
  ...
  if m_AbiType in [atBDS2005, atBDS2006, atDelphi2007, atDelphi2009, atDelphi2010,
    atDelphiXE, atDelphiXE2, atDelphiXE3, atDelphiXE4] then
  begin
...
begin
  case m_AbiType of
    ...
    atDelphi2010, atDelphiXE, atDelphiXE2, atDelphiXE3, atDelphiXE4:
      case ao of
        aoCodeTemp: Result := 'bds.dci'; // 代码模板
