...
begin
  ...
  begin
    ...
    else if m_AbiType in [atDelphiXE, atDelphiXE2, atDelphiXE3, atDelphiXE4, atDelphiXE5] then
  ...
  begin
    if m_AbiType in [atDelphiXE, atDelphiXE2, atDelphiXE3, atDelphiXE4, atDelphiXE5] then
...
begin
  ...
  if m_AbiType in [atBDS2005, atBDS2006, atDelphi2007, atDelphi2009, atDelphi2010,
    atDelphiXE, atDelphiXE2, atDelphiXE3, atDelphiXE4, atDelphiXE5] then
  begin
