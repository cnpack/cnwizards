...
* 单元标识：$Id: CleanClass.pas,v 1.11 2009/01/02 08:36:30 liuxiao Exp $
...
type
  TCnIDEs = (ciDelphi5, ciDelphi6, ciDelphi7, ciDelphi8, ciDelphi9, ciDelphi10,
    ciDelphi11, ciDelphi12, ciBCB5, ciBCB6);
...
const
  SCnIDENames: array[TCnIDEs] of string =
    ('Delphi 5', 'Delphi 6', 'Delphi 7', 'Delphi 8', 'BDS 2005', 'BDS 2006',
     'RAD Studio 2007', 'RAD Studio 2009', 'C++Builder 5', 'C++Builder 6');
