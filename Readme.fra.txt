...
C++ Builder / BDS / RAD Studio pour améliorer l'efficacité du développement.
...
Chinois simplifié, chinois traditionnel, anglais, russe, allemand, Français
et portugais.
...
======================================================================
    ...
    Vous devez d'abord télécharger le code source de cnpack et le décompresser en
le même répertoire où se trouve la source cnwizards. Ensuite, ouvrez le projet
